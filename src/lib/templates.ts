...
export const DELIVERABLE_TEMPLATE: Seed[] = [
  ...
  { category: "marketing", title: "Social — creative concept locked", owner: "Kiel", lead_days: 24, sort_order: 2 },
  { category: "marketing", title: "App promo live in Arketa", owner: "Abby", lead_days: 21, sort_order: 3 },
  { category: "marketing", title: "Email — announcement", owner: "Abby", lead_days: 21, sort_order: 4 },
  { category: "marketing", title: "Social — general post", owner: "Kiel", lead_days: 18, sort_order: 5 },
  { category: "marketing", title: "Email confirmation to trainers", owner: "Amanda", lead_days: 14, sort_order: 6 },
  { category: "marketing", title: "Social — post with trainer", owner: "Kiel", lead_days: 12, sort_order: 7 },
  { category: "marketing", title: "Trainer confirmation received", owner: "Amanda", lead_days: 10, sort_order: 8 },
